...
'pubsub' => [
    ...
    'topic_auto_creation' => true,
    'subscription_auto_creation' => true,
],
```

## Avoiding Administrator Operations Limits

To avoid limit issues, change the `topic_auto_creation` and `subscription_auto_creation` flags to false.
